package com.zhengqing.demo.easyexcel.listener;
...
import com.zhengqing.demo.service.impl.EasyExcelReadServiceImpl;
...
public class DemoDataListener implements ReadListener<DemoData> {
     ...
     */
    private IEasyExcelReadService easyExcelService;

    public DemoDataListener() {
        // 这里是demo，所以随便new一个。实际使用如果到了spring,请使用下面的有参构造函数
        this.easyExcelService = new EasyExcelReadServiceImpl();
    }

    /**
     * 如果使用了spring,请使用这个构造方法。每次创建Listener的时候需要把spring管理的类传进来
     *
     * @param easyExcelService
     */
    public DemoDataListener(IEasyExcelReadService easyExcelService) {
...
//        this.easyExcelService.save(this.cachedDataList);
        log.info("存储数据库成功！");
    }
}
